        ...
        <div className="px-4">
            <div className=" w-100 md:h-[500px] h-[650px] md:mt-10 mt-1 mb-24 grid md:grid-cols-3 grid-cols-1">
                ...
                <div style={{
                    ...
                    }} className="lg:w-[18rem] md:w-[17rem] md:h-[23rem] lg:h-[25rem] hidden md:block bg-cover bg-center self-center"></div>
                </div>
                <div className="p-7 md:col-span-2">
                    <div>
                        <h3 className="text-customBlue font-bold text-xl text-center md:text-left">Discover</h3>
                        <h2 className="text-4xl text-center md:text-left font-bold underline decoration-customlightBlue decoration-[4px] underline-offset-[9px]">About Me</h2>
