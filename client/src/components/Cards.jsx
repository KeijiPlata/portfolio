  ...
  return (
    <a href={link} target="_blank">
      ...
      >
        ...
        text-white font-bold hover:bg-white hover:text-customBlue dark:hover:text-customViolet cursor-pointer ${
          animate ? "animate__animated animate__tada" : ""
        }`}
        >
          <div className="lg:text-6xl md:text-4xl text-5xl">{icon}</div>
