    ...
    return(
        <div className="px-4">
            ...
            w-100 h-96 bg-gray-200 rounded-md mt-28 grid md:grid-cols-2 grid-cols-1"> */}
                <div className="m-auto w-100 lg:h-[420px] md:h-[350px] h-[300px] bg-blue-300 rounded-md mt-28 grid md:grid-cols-2 grid-cols-1">
                <div className="text-white bg-red-400 flex flex-col gap-3 justify-center lg:pl-10 md:pl-5 pl-5 order-last md:order-1">
                    <div>
                ...
                <div className="bg-green-400 order-2">
