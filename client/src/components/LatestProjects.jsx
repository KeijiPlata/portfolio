  ...
  return (
    <div className="md:px-4 my-20 flex flex-col gap-5" id="projects">
      <div className="flex flex-col">
        <h3
          className="text-center text-customBlue font-bold font-Poppins text-xl"
          data-aos="fade-up"
        ...
        <h2
          className="text-center text-4xl font-bold underline font-Poppins decoration-customBlue
