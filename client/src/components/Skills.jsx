...
const Skills = () => {
    const data = [
        ...
        {icon: <SiServerless/>, name: "Serverless", link: "https://www.serverless.com/"},
    ...
    return(
        <div className="px-4">
            ...
            <div className="bg-customBlue rounded-md w-100 md:h-[525px] lg:h-[575px] h-[900px] mt-10 mb-24 grid md:grid-cols-3 grid-cols-1">
                ...
                <div style={{
                    ...
                    }} className="lg:w-[22rem] md:w-[16rem] md:h-[21rem] lg:h-[27rem] hidden md:block bg-cover bg-center self-center" 
